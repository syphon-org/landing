          ...
          <div className="w-full flex flex-col md:flex-row py-6">
            ...
            <div className="flex-1">
              ...
              <ul className="list-reset mb-6">
                ...
                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                  <a href="mailto:contact@syphon.org?subject=Syphon%20App&body" className="no-underline hover:underline text-white-800 hover:text-orange-500">contact</a>
                </li>
                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
            ...
            <div className="flex-1">
              ...
              <ul className="list-reset mb-6">
                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                  <a href="https://www.instagram.com/syphonapp" className="no-underline hover:underline text-white-800 hover:text-orange-500">instagram</a>
                </li>
                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                  <a href="https://github.com/syphon-org" className="no-underline hover:underline text-white-800 hover:text-orange-500">github</a>
                </li>
                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                  <a href="https://twitter.com/syphonapp" className="no-underline hover:underline text-white-800 hover:text-orange-500">twitter</a>
                </li>
              </ul>
            </div>
            <div className="flex-1">
