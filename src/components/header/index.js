    ...
    <div className="container flex flex-wrap items-center justify-between mx-auto mt-0 px-6 py-5">
      ...
      <div className="w-full justify-end flex flex-wrap md:items-center md:w-auto menu-content">
        <div className="text-md text-right items-center md:flex-grow">
          <a href="/about" className="block text-xl mt-4 md:mt-0 md:mr-6 text-white hover:text-teal-200 md:inline-block  ">
            About
          </a>
          <a href="/support" className="block text-xl mt-4 md:mt-0 md:mr-6 text-white hover:text-teal-200 md:inline-block ">
            Support
          </a>
          <a href="https://github.com/syphon-org/syphon/" className="block text-xl mt-4 md:mt-0 md:mr-6 text-white hover:text-teal-200 md:inline-block ">
            Github
          </a>
