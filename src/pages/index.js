    ...
    <div className="app sans-serif gradient">
      ...
      <section className="bg-white  py-8">
        <div className="container max-w-5xl mx-auto m-8">
          <h1 className="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">features</h1>
          ...
          <div className="flex flex-wrap flex-col-reverse sm:flex-row lg:mt-16">
            <div className="w-full sm:w-1/2 p-6 mb-6">
              <div className="w-5/6 sm:h-64 mx-auto" viewBox="0 0 1176.60617 873.97852">
            ...
            <div className="flex flex-wrap lg:mt-16">
              <div className="w-5/6 sm:w-1/2 p-6">
                <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">customize it</h3>
                <p className="text-gray-600 mb-8">
          ...
          <h1 className="w-full mb-2 mt-32 text-5xl font-bold leading-tight text-center text-gray-800">future goals</h1>
          <div className="w-full mb-4">
            <div className="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t" />
          </div>
          ...
          <div className="flex flex-wrap lg:mt-16">
            <div className="w-5/6 sm:w-1/2 p-6">
              <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">peer to peer messaging</h3>
              <p className="text-gray-600 mb-8">
          ...
          <div className="flex flex-wrap flex-col-reverse sm:flex-row lg:mt-16">
            ...
            <div className="w-full sm:w-1/2 p-6 mt-6">
              <div className="align-middle">
                <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">transfer data</h3>
                <p className="text-gray-600 mb-8">
      ...
      <section className="container mx-auto text-center py-6 mb-4">
        ...
        <div className="flex flex-row justify-center items-center">
          <a className="text-4xl leading-tight underline mx-8" style={{ cursor: 'pointer', letterSpacing: '0.5' }}>
            help@syphon.org
          </a>
        </div>
        ...
        <div className="flex flex-row flex-wrap text-center justify-center items-center">
          <a className="shadow mx-4 my-4" href="https://patreon.com/ereio">
            <img className="h-16" alt="Patreon" src="assets/external/patreon.png" />
          </a>
          <a className="shadow mx-4 my-4" href="https://liberapay.com/ereio">
            <img className="h-16" alt="Libera Pay" src="assets/external/fund-via-liberapay.png" />
          </a>
          <a
