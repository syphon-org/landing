          ...
          <section className="container bg-white text-black max-w-5xl mx-auto ">
            <div className="splash flex flex-grow flex-col justify-start items-center bg-white">
              <div className="bg-white">
                <h4 className="text-4xl pb-4 bg-white">why</h4>
                <p className="text-xl text-black bg-white">
                  ...
                  {' '}
                  <a className="underline" href="https://www.newyorker.com/magazine/2020/10/26/taking-back-our-privacy">centralization of a platform and a focus on product will only help.</a>
                  {' '}
                  ...
                  chat protocol,
                  {' '}
                  <a className="underline" href="https://matrix.org/blog/2020/06/02/introducing-p-2-p-matrix">and in a way already is</a>
                  ,
