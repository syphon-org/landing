        ...
        <div className="app sans-serif">
            ...
            <section class="pt-32">
                <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row justify-between items-center">
                    <div class="flex flex-col w-full md:w-2/5 justify-center md:items-start sm:items-center text-center md:text-left">
                        ...
                        <h1 class="my-4 text-5xl leading-tight rubik">chat with your privacy and freedom intact</h1>
                        <p class="leading-normal text-2xl mb-8 rubik">a not for profit, open source matrix client with a focus on privacy and ease of use</p>
                        <div class='flex flex-row justify-center items-center'>
                            ...
                            <div class="flex justify-center items-center" style={{ minHeight: 52, minWidth: 172, }}>
